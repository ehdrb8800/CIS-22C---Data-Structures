...
public class Hash<T extends Comparable<T>> {
	 ...
	 * output
	 * 
	 * @precondition length of bucket != 0
	 * @param bucket the index in the Table
	 */
	public void printBucket(int bucket) throws NoSuchElementException {
		if (Table.get(bucket).getLength() == 0) {
			throw new NoSuchElementException("printBucket(): There's no element in this bucket");
		}
