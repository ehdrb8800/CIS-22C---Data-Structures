...
public class Movie implements Comparable<Movie> {
	...
	public String toString() {
		...
		String result = "Title: " + this.title + "\nDirector: " + this.director + "\nYear: " + this.year
				+ "\nGross in Million: $" + num.format(this.grossMillions) + "\n";
		return result;
	}
	...
	public boolean equals(Object o) {
		if (o == this) {
			...
			if (this.title.equals(M.title) && this.director.equals(M.director)) {
				return true;
			}
	...
	public int compareTo(Movie otherMovie) {
		for (int i = 0; i < this.title.length(); i++) {
			if (this.title.charAt(i) < otherMovie.title.charAt(i)) {
				return -1;
			}

			else if (this.title.charAt(i) > otherMovie.title.charAt(i)) {
				return 1;
			}
		}
